...
function createBtn() {
    ...
    returnBtn.addEventListener('click', function () {
        wrapper.innerHTML = '';
        console.log("The old screen was ".concat(_index__WEBPACK_IMPORTED_MODULE_0__.state.screen));
        _index__WEBPACK_IMPORTED_MODULE_0__.state.screen = 'albums';
        console.log("The new screen is ".concat(_index__WEBPACK_IMPORTED_MODULE_0__.state.screen));
    });
    return returnBtn;
}
...
function createLoadMoreBtn(clickHandler) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            loadMoreBtn = (0,_createElement__WEBPACK_IMPORTED_MODULE_0__["default"])({
                tag: 'button',
...
/* harmony import */ var _renderGallery__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./renderGallery */ "./src/renderGallery.ts");
/* harmony import */ var _getData__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./getData */ "./src/getData.ts");
/* harmony import */ var _renderAlbums__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./renderAlbums */ "./src/renderAlbums.ts");
/* harmony import */ var _createElement__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./createElement */ "./src/createElement.ts");
/* harmony import */ var _setThumbnailSource__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./setThumbnailSource */ "./src/setThumbnailSource.ts");
/* harmony import */ var _enums__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./enums */ "./src/enums.ts");
/* harmony import */ var _renderFullImage__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./renderFullImage */ "./src/renderFullImage.ts");
...
var defaultAlbumsNumberOnPage = 8; // переименовать в defaultAlbumsAmount
var pageCounter = 1;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0,_getData__WEBPACK_IMPORTED_MODULE_2__.getData)("https://jsonplaceholder.typicode.com/albums/?_start=".concat(defaultAlbumsNumberOnPage * pageCounter + 1, "&_end=").concat(defaultAlbumsNumberOnPage * pageCounter +
                ...
                case 1:
                        ...
                        return __generator(this, function (_d) {
                            switch (_d.label) {
                                case 0:
                                    ...
                                    album = (0,_createElement__WEBPACK_IMPORTED_MODULE_4__["default"])({
                                        tag: 'div',
                                        className: 'album',
                                    ...
                                    _b = _createElement__WEBPACK_IMPORTED_MODULE_4__["default"];
                                    _c = {
                                        tag: 'img',
                                        className: 'album__first-image',
                                        attribute: 'src'
                                    };
                                    return [4 /*yield*/, (0,_setThumbnailSource__WEBPACK_IMPORTED_MODULE_5__.setThumbnailSource)(newAlbums[i].id)];
                                case 1:
                                    thumbnail = _b.apply(void 0, [(_c.attrValue = _d.sent(),
                                            _c)]);
                                    album.appendChild(thumbnail);
                                    albumInfo = (0,_createElement__WEBPACK_IMPORTED_MODULE_4__["default"])({
                                        tag: 'div',
                                        className: 'album__info',
                                    });
                                    album.appendChild(albumInfo);
                                    heading = (0,_createElement__WEBPACK_IMPORTED_MODULE_4__["default"])({
                                        tag: 'h3',
                                        className: 'album__heading',
                                        value: newAlbums[i].title,
                                    });
                                    albumInfo.appendChild(heading);
                                    id = (0,_createElement__WEBPACK_IMPORTED_MODULE_4__["default"])({
                                        tag: 'p',
                                        className: 'album__ID',
                    ...
                    _a.label = 2;
                case 2:
                    if (!(i < newAlbums.length)) return [3 /*break*/, 5];
...
var state = {
    ...
    set screen(type) {
        ...
        (0,_renderAlbums__WEBPACK_IMPORTED_MODULE_3__.renderAlbums)();
    },
    get screen() {
        return this._screen;
    },
...
function renderPage() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!(screenType === _enums__WEBPACK_IMPORTED_MODULE_6__.ScreenType.albums)) return [3 /*break*/, 1];
                    (0,_renderAlbums__WEBPACK_IMPORTED_MODULE_3__.renderAlbums)();
                    return [3 /*break*/, 4];
                case 1:
                    if (!(screenType === _enums__WEBPACK_IMPORTED_MODULE_6__.ScreenType.gallery)) return [3 /*break*/, 4];
                    if (!(galleryMode === _enums__WEBPACK_IMPORTED_MODULE_6__.GalleryMode.fullscreen)) return [3 /*break*/, 3];
                    return [4 /*yield*/, (0,_renderGallery__WEBPACK_IMPORTED_MODULE_1__.renderGallery)()];
                case 2:
                    _a.sent();
                    (0,_renderFullImage__WEBPACK_IMPORTED_MODULE_7__["default"])(localStorage.getItem('fullImageUrl'));
                    return [3 /*break*/, 4];
                case 3:
                    (0,_renderGallery__WEBPACK_IMPORTED_MODULE_1__.renderGallery)();
...
/* harmony export */   "ScreenType": () => (/* reexport safe */ _enums__WEBPACK_IMPORTED_MODULE_5__.ScreenType)
/* harmony export */ });
/* harmony import */ var ___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! . */ "./src/index.ts");
/* harmony import */ var _createElement__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./createElement */ "./src/createElement.ts");
/* harmony import */ var _setThumbnailSource__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./setThumbnailSource */ "./src/setThumbnailSource.ts");
/* harmony import */ var _getData__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./getData */ "./src/getData.ts");
/* harmony import */ var _createLoadMoreBtn__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./createLoadMoreBtn */ "./src/createLoadMoreBtn.ts");
...
function renderAlbums() {
    return __awaiter(this, void 0, void 0, function () {
        var albumsArr, pageInfo, headingBig, pageDescription, albumsWrapper, _loop_1, i, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 6, , 7]);
                    return [4 /*yield*/, (0,_getData__WEBPACK_IMPORTED_MODULE_3__.getData)(albumsUrl)];
                case 1:
                    albumsArr = _a.sent();
                    pageInfo = (0,_createElement__WEBPACK_IMPORTED_MODULE_1__["default"])({
                        tag: 'div',
                        className: 'albumPage__info',
                    });
                    wrapper.appendChild(pageInfo);
                    headingBig = (0,_createElement__WEBPACK_IMPORTED_MODULE_1__["default"])({
                        tag: 'h1',
                        className: 'albumPage__heading',
                        value: 'Image Gallery',
                    });
                    pageInfo.appendChild(headingBig);
                    pageDescription = (0,_createElement__WEBPACK_IMPORTED_MODULE_1__["default"])({
                        tag: 'p',
                        className: 'albumPage__description',
                        value: "".concat(defaultAlbumsNumberOnPage, " albums filled with various photos for you!"),
                    });
                    pageInfo.appendChild(pageDescription);
                    albumsWrapper = (0,_createElement__WEBPACK_IMPORTED_MODULE_1__["default"])({
                        tag: 'div',
                        ...
                        return __generator(this, function (_d) {
                            switch (_d.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, (0,_setThumbnailSource__WEBPACK_IMPORTED_MODULE_2__.setThumbnailSource)(i)];
                                case 1:
                                    thumbnail = _b.apply(void 0, [(_c.attrValue = _d.sent(),
                                            _c)]);
                                    album.appendChild(thumbnail);
                                    albumInfo = (0,_createElement__WEBPACK_IMPORTED_MODULE_1__["default"])({
                                        tag: 'div',
                                        className: 'album__info',
                                    });
                                    album.appendChild(albumInfo);
                                    ...
                                    albumInfo.appendChild(id);
                                    album.addEventListener('click', function () {
                                        console.log("State id #1: ".concat(___WEBPACK_IMPORTED_MODULE_0__.state.id));
                                        console.log("Album id #1: ".concat(album.id));
                                        ___WEBPACK_IMPORTED_MODULE_0__.state.id = Number(album.id);
                                        console.log("State id #2: ".concat(___WEBPACK_IMPORTED_MODULE_0__.state.id));
                                        console.log("Album id #2: ".concat(album.id));
                                        localStorage.setItem('albumID', album.id);
                                        ___WEBPACK_IMPORTED_MODULE_0__.state.screen = 'gallery';
                                    });
                                    return [2 /*return*/];
                            }
                        });
                ...
                case 4:
                    ...
                    return [3 /*break*/, 2];
                case 5:
                    (0,_createLoadMoreBtn__WEBPACK_IMPORTED_MODULE_4__.createLoadMoreBtn)(___WEBPACK_IMPORTED_MODULE_0__.onLoadMore);
                    localStorage.setItem('screenType', _enums__WEBPACK_IMPORTED_MODULE_5__.ScreenType.albums);
                    return [3 /*break*/, 7];
                case 6:
                    err_1 = _a.sent();
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ renderFullImage)
/* harmony export */ });
...
function renderFullImage(imageURL) {
    ...
    var fullImage = (0,_createElement__WEBPACK_IMPORTED_MODULE_1__["default"])({
        tag: 'img',
    ...
    localStorage.setItem('screenType', _enums__WEBPACK_IMPORTED_MODULE_0__.ScreenType.gallery);
    localStorage.setItem('galleryMode', _enums__WEBPACK_IMPORTED_MODULE_0__.GalleryMode.fullscreen);
}
...
/* harmony export */   "imageOrder": () => (/* binding */ imageOrder)
/* harmony export */ });
/* harmony import */ var _createElement__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./createElement */ "./src/createElement.ts");
...
/* harmony import */ var _renderFullImage__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./renderFullImage */ "./src/renderFullImage.ts");
var __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
...
function renderGallery() {
    return __awaiter(this, void 0, void 0, function () {
        var albumId, photos, _a, albumsUrl, galleryWrapper, albumsArr, galleryInfo, galleryHeading, photosArr, modal_1, closeModal, modalContent_1, nextImage, previousImage, _loop_1, i, images, err_1;
        var _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    albumId = ___WEBPACK_IMPORTED_MODULE_2__.state.id ? ___WEBPACK_IMPORTED_MODULE_2__.state.id : Number(localStorage.getItem('albumID'));
                    if (!(Object.keys(___WEBPACK_IMPORTED_MODULE_2__.state.photos).length !== 0)) return [3 /*break*/, 1];
                    photos = ___WEBPACK_IMPORTED_MODULE_2__.state.photos;
                    return [3 /*break*/, 3];
                case 1:
                    _b = {};
                    _a = albumId;
                    return [4 /*yield*/, (0,_getData__WEBPACK_IMPORTED_MODULE_3__.getData)("https://jsonplaceholder.typicode.com/albums/".concat(albumId, "/photos"))];
                case 2:
                ...
                case 4:
                    _c.trys.push([4, 6, , 7]);
                    wrapper.innerHTML = '';
                    galleryWrapper = (0,_createElement__WEBPACK_IMPORTED_MODULE_0__["default"])({
                        tag: 'div',
                ...
                case 5:
                    albumsArr = _c.sent();
                    galleryInfo = (0,_createElement__WEBPACK_IMPORTED_MODULE_0__["default"])({
                        tag: 'div',
                        className: 'gallery__info',
                    });
                    galleryWrapper.appendChild(galleryInfo);
                    galleryHeading = (0,_createElement__WEBPACK_IMPORTED_MODULE_0__["default"])({
                        tag: 'h1',
                        className: 'gallery__heading',
                        value: "".concat(albumsArr[albumId].title),
                    });
                    galleryInfo.appendChild(galleryHeading);
                    photosArr = photos[albumId];
                    modal_1 = (0,_createElement__WEBPACK_IMPORTED_MODULE_0__["default"])({
                        tag: 'div',
                        className: 'modal',
                    });
                    closeModal = (0,_createElement__WEBPACK_IMPORTED_MODULE_0__["default"])({
                        tag: 'span',
                        className: 'close-modal',
                        value: 'X',
                    });
                    modal_1.appendChild(closeModal);
                    modalContent_1 = (0,_createElement__WEBPACK_IMPORTED_MODULE_0__["default"])({
                        tag: 'div',
                        className: 'modal-content',
                    });
                    modal_1.appendChild(modalContent_1);
                    nextImage = (0,_createElement__WEBPACK_IMPORTED_MODULE_0__["default"])({
                        tag: 'a',
                    ...
                    nextImage.addEventListener('click', function next() {
                        ...
                        console.log(photos, albumId, imageOrder);
                        fullImage = (0,_createElement__WEBPACK_IMPORTED_MODULE_0__["default"])({
                            tag: 'img',
                            className: 'gallery__image--selected',
                            attribute: 'src',
                            attrValue: "".concat(photos[albumId][parseInt(imageOrder + 1)].url)
                        });
                        modalContent_1.appendChild(fullImage);
                        imageOrder = parseInt(imageOrder) + 1;
                    });
                    previousImage = (0,_createElement__WEBPACK_IMPORTED_MODULE_0__["default"])({
                        tag: 'a',
                    ...
                    previousImage.addEventListener('click', function next() {
                        ...
                        fullImage = (0,_createElement__WEBPACK_IMPORTED_MODULE_0__["default"])({
                            ...
                            className: 'gallery__image--selected',
                            attribute: 'src',
                            attrValue: "".concat(photos[albumId][imageOrder - 1].url)
                        });
                        modalContent_1.appendChild(fullImage);
                        imageOrder = parseInt(imageOrder) - 1;
                    });
                    closeModal.addEventListener('click', function () {
                        ...
                        localStorage.setItem('galleryMode', _enums__WEBPACK_IMPORTED_MODULE_4__.GalleryMode.thumbnails);
                    });
                    document.body.appendChild(modal_1);
                    _loop_1 = function (i) {
                        var imageContainer = (0,_createElement__WEBPACK_IMPORTED_MODULE_0__["default"])({
                            tag: 'div',
                            className: 'gallery__image-container',
                        });
                        galleryWrapper.appendChild(imageContainer);
                        var image = (0,_createElement__WEBPACK_IMPORTED_MODULE_0__["default"])({
                            tag: 'img',
                        ...
                        image.addEventListener('click', function () {
                            ...
                            (0,_renderFullImage__WEBPACK_IMPORTED_MODULE_5__["default"])(localStorage.getItem('fullImageUrl'));
                        });
                    };
                    ...
                    localStorage.setItem('screenType', _enums__WEBPACK_IMPORTED_MODULE_4__.ScreenType.gallery);
                    localStorage.setItem('galleryMode', _enums__WEBPACK_IMPORTED_MODULE_4__.GalleryMode.thumbnails);
                    return [3 /*break*/, 7];
                case 6:
                    err_1 = _c.sent();
                    console.log('The gallery wasnt created', err_1);
                    return [3 /*break*/, 7];
                case 7: return [2 /*return*/];
            }
        });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    _index__WEBPACK_IMPORTED_MODULE_1__.state.photos = { id: albumId, photos: photosArr };
                    if (result !== undefined) {
